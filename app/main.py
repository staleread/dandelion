...
from app.common.template.core import web_templates
...
async def bad_request_exception_handler(request: Request, _):
    return web_templates.TemplateResponse(request, name="errors/400.html")
...
async def forbidden_exception_handler(request: Request, _):
    return web_templates.TemplateResponse(request, name="errors/403.html")


@app.exception_handler(404)
async def not_found_exception_handler(request: Request, _):
    return web_templates.TemplateResponse(request, name="errors/404.html")


@app.exception_handler(500)
async def internal_error_exception_handler(request: Request, _):
    print(traceback.format_exc())
    return web_templates.TemplateResponse(request, name="errors/500.html")
